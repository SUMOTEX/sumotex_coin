    ...
    PausableUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC20_init("Homevest Coin", "HOMEVEST INTERNATIONAL LIMTED (LL17807)");
        __Ownable_init();
        __Pausable_init();
        _totalSupply = 250000 * 10**uint256(decimals());
        ...
        sumoName = "Sumolab";
        fundManagerName = "HOMEVEST INTERNATIONAL LIMTED (LL17807)";
        auditLink = "";
    }
