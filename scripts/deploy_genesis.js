...
async function main () {
  const GenesisFST = await ethers.getContractFactory('GenesisFST');
  console.log('Deploying GenesisFST ...');
  const gasEstimate = await GenesisFST.deploy.estimateGas();
  console.log("Estimated gas:", gasEstimate.toString());
//   const box = await upgrades.deployProxy(GenesisFST, { initializer: 'initialize' });
//   await box.deployed();
...
//   console.log('GenesisFST deployed to:', box.address);
}
//Goerli
...
// GenesisFST deployed to: 0xA3021870f92AF52dD1286f53350e69f7ABD938c4
...
// 0x29D2e705dC22E8F2c7173524EF3C99CF5DE1F626  getAdminAddress
// GenesisFST deployed to: 0x26E60c1A2Ea2505F0299E62eA794c0C0dE3670D6
main();