    ...
    PausableUpgradeable
{
   ...
   /**
    ...
    function mintAsInvestor(address to, uint256 amount) public whenNotPaused onlyOwner {
        require(amount>=(1000* 10**uint256(decimals())),"minimum purchase is a 1,000 Token");
        require(_initialSupply + amount <= _totalSupply);
        _mint(to, amount);
        _initialSupply += amount;
    }
